...
local aquiloMapGenSettings = RAW.planet.aquilo.map_gen_settings
assert(aquiloMapGenSettings ~= nil)
RAW["autoplace-control"]["aquilo_crude_oil"].localised_name = {"", "[entity=natural-gas-well]", {"entity-name.natural-gas-well"}}
aquiloMapGenSettings.autoplace_settings.entity.settings["natural-gas-well"] = aquiloMapGenSettings.autoplace_settings.entity.settings["crude-oil"]
aquiloMapGenSettings.autoplace_settings.entity.settings["crude-oil"] = nil
aquiloMapGenSettings.property_expression_names["entity:natural-gas-well:probability"] = aquiloMapGenSettings.property_expression_names["entity:crude-oil:probability"]
aquiloMapGenSettings.property_expression_names["entity:natural-gas-well:richness"] = aquiloMapGenSettings.property_expression_names["entity:crude-oil:richness"]
aquiloMapGenSettings.property_expression_names["entity:crude-oil:probability"] = nil
aquiloMapGenSettings.property_expression_names["entity:crude-oil:richness"] = nil
