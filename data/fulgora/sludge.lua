...
extend({
	...
	},
	{
		...
		results = {
			...
			{ type = "item",  name = "rusty-iron-gear-wheel", amount = 1, probability = 0.02,  show_details_in_recipe_tooltip = false },
			{ type = "item",  name = "rusty-iron-stick",      amount = 1, probability = 0.02,  show_details_in_recipe_tooltip = false },
