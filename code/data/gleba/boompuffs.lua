...
local boompuffPlant = table.deepcopy(data.raw.tree.boompuff)
...
local boomsacItem = table.deepcopy(data.raw.capsule["grenade"])
...
local boomsacProjectile = table.deepcopy(data.raw.projectile["grenade"])
