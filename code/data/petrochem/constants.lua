...
Export.richgasFlowColor = {r = .8, g = .9, b = .78, a = 1}
--Export.drygasColor = {r = .48, g = .69, b = .50, a = 1} -- A bit too similar to rich gas.
Export.drygasColor = {r = .30, g = .45, b = .31, a = 1}
Export.drygasFlowColor = {r = .4, g = .65, b = .4, a = 1}
Export.drygasTint = {r = .40, g = .60, b = .42, a = 1}
